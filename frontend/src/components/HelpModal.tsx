...
const SECTIONS = {
  ...
  shortcuts: [
    ...
    // Кроки відтворення у формі бага — see NewBug.handleStepKeyDown
    ['↵', 'У полі кроку відтворення — додати новий крок під поточним'],
    [BACKSPACE_KEY, 'У порожньому кроці — видалити та повернутись до попереднього'],
    ['?', 'Показати цю довідку'],
