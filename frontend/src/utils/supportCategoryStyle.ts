...
export const SUPPORT_ICON_OPTIONS: { id: SupportCategoryIcon; label: string }[] = [
  ...
  { id: 'star', label: 'Зірка' },
  { id: 'clock', label: 'Годинник' },
  { id: 'ai', label: 'AI' },
  { id: 'tag', label: 'Тег' },
  { id: 'activity', label: 'Активність' },
  { id: 'shield', label: 'Щит' },
  { id: 'flag', label: 'Прапор' },
  { id: 'image', label: 'Зображення' },
  { id: 'inbox', label: 'Інбокс' },
  { id: 'bell', label: 'Дзвоник' },
  { id: 'chart', label: 'Графік' },
  { id: 'beaker', label: 'Колба' },
  { id: 'play', label: 'Play' },
  { id: 'edit', label: 'Олівець' },
  { id: 'folder', label: 'Тека' },
  ...
  { id: 'refresh', label: 'Оновити' },
  { id: 'upload', label: 'Завантажити' },
  { id: 'download', label: 'Скачати' },
]
